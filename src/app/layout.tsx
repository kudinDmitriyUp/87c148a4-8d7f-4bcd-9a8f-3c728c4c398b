...
export const metadata: Metadata = {
  title: "Brew Haven - Local Specialty Coffee Shop",
  description: "Discover exceptional artisanal coffee, fresh pastries, and a welcoming community space in downtown. Visit Brew Haven today.",
  keywords: "local coffee shop, specialty coffee, cafe, espresso, cappuccino, barista, artisan roastery, community coffee",
  metadataBase: new URL("https://brewhaven.local"),
  alternates: {
    canonical: "https://brewhaven.local"
  },
  openGraph: {
    title: "Brew Haven - Local Specialty Coffee Shop",
    description: "Discover exceptional artisanal coffee, fresh pastries, and a welcoming community space in downtown.",
    type: "website",
    siteName: "Brew Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1765915786499-yponps2k.jpg",
  ...
  twitter: {
    ...
    title: "Brew Haven - Local Specialty Coffee Shop",
    description: "Discover exceptional artisanal coffee, fresh pastries, and community.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1765915786499-yponps2k.jpg"]
  },
  robots: {
    index: true,
    follow: true
